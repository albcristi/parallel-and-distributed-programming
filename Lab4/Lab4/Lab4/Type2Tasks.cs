...
namespace Lab4
{
    ...
    class Type2Tasks
    {
        ...
        public Type2Tasks(List<string> hosts)
        {
            this.hosts = hosts;
        ...
        private void FetchData(object arguments)
        {
            ...
            MyHttpRequest request = new MyHttpRequest(host,
                                                      ...
                                                      ipEndpoint,
                                                      identificator);
            this.SocketBeginConnect(request).Wait();
            this.SocketBeginSend(request).Wait();
            this.SocketBeginReceive(request).Wait();
        ...
        private Task SocketBeginSend(MyHttpRequest request)
        {
            ...
            request.socket.BeginSend(data,
                                     ...
                                     request);
            return Task.FromResult(request.isSent.WaitOne());
        }
